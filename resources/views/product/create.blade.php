        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" class="w-full flex flex-col items-center">
            ...
            <div class="w-full max-w-4xl mb-8">
                <div class="flex items-center gap-2 mb-6 text-sm">
                    ...
                    <span class="material-symbols-outlined text-[16px] text-slate-400">chevron_right</span>
                    <span class="text-slate-900 font-medium">Add New</span>
                </div>
                <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight mb-2">Add New Product</h1>
                        <p class="text-slate-500 text-base">Create a new listing for your store inventory.</p>
                    </div>
                    <div class="flex gap-3">
                        <button type="button" class="px-5 py-2.5 rounded-lg border border-slate-200 text-slate-700 font-medium hover:bg-slate-50 transition-colors text-sm">Cancel</button>
            ...
            <div class="w-full max-w-4xl bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                <div class="p-8">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input name="precio" id="precio" value="{{ old('precio') }}" class="w-full rounded-lg bg-slate-50 border border-slate-200 pl-8 pr-4 py-3 text-base text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none" placeholder="99.99" step="0.01" type="number" />
                                    </div>
                                </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <textarea name="description" id="description" class="w-full rounded-lg bg-slate-50 border border-slate-200 px-4 py-3 text-base text-slate-900 placeholder:text-slate-400 focus:ring-2 focus:ring-primary focus:border-transparent transition-all outline-none resize-none" placeholder="Características del producto..." rows="4" >{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="w-full">
                            <label class="text-slate-700 text-sm font-medium uppercase tracking-wider mb-2 block">Upload Image</label>
